...
pub type threading_mutex_t = *mut ::types::raw_types::c_void;
extern "C" {
    #[link_name = "\u{1}mbedtls_time"]
    pub fn time(arg1: *mut ::types::raw_types::c_longlong) -> ::types::raw_types::c_longlong;
}
...
pub const KEY_LENGTH_NONE: _bindgen_ty_1 = 0;
pub const KEY_LENGTH_DES: _bindgen_ty_1 = 64;
pub const KEY_LENGTH_DES_EDE: _bindgen_ty_1 = 128;
pub const KEY_LENGTH_DES_EDE3: _bindgen_ty_1 = 192;
